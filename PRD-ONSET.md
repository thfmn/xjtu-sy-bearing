...
- [x] Implement `create_onset_dataset(features_df, onset_labels, window_size=10)`:
...
- [x] Total parameters under 10K (lightweight)
- [x] Model supports `model.predict_proba()` equivalent via sigmoid output
